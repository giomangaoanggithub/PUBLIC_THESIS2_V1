...
try {
  ...
  $sql = "INSERT INTO user_accounts (email, username, password, contact_number, user_role)
  VALUES ('$email_input', '$username_input', '$password_input', '$contact_num_input', '$user_role_input')";
